...
flag_N1_Stage=zeros(1,total_epoch);
threshold_time_SEM1=func_threshold(time_SEM1)/4;
for i=1:total_epoch
    if (time_SEM1(i)<=threshold_time_SEM1)==1
        flag_N1_Stage(i)=1;
    else
        flag_N1_Stage(i)=0;
    end
...
ylim([-1 2])
set(gca,'YTick',-1:1:2)
set(gca,'YTickLabel',{'','None','Predict N1',''})
ylabel('Stages')
stages=[];
for i=1:total_epoch
